...
public static class TrainingPlanLlmPromptFormatter
{
        ...
        AdviceNarrationStyle trainerStyle = AdviceNarrationStyle.RegularTrainer)
    {
        ...
        return new TrainingPlanLlmInput(
            report.DisplayName,
            audienceLevel,
            TrainingTextFormatter.BuildAudienceDescription(audienceLevel),
            trainerStyle,
            TrainingTextFormatter.BuildTrainerDescription(trainerStyle),
            ...
            report.Topics
                ...
                .Take(5)
                .Select(TrainingTextFormatter.FormatOpening)
                .ToList());
    }
