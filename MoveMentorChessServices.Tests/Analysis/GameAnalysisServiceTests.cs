...
"""),
    ...
    private static string? TryFindStockfishExe()
    {
        ...
        [
            ...
            Path.Combine(Directory.GetCurrentDirectory(), "MoveMentorChessServices", "bin", "Debug", "net8.0-windows", "stockfish.exe"),
            Path.Combine(Directory.GetCurrentDirectory(), "MoveMentorChessServices.Tests", "bin", "Debug", "net8.0-windows", "stockfish.exe")
        ];
