...
""";
    ...
    {
        string folder = Path.Combine(Path.GetTempPath(), $"stockifhsgui-opening-import-{Guid.NewGuid():N}");
...
""";
    ...
    {
        string folder = Path.Combine(Path.GetTempPath(), $"stockifhsgui-opening-invalid-{Guid.NewGuid():N}");
        Directory.CreateDirectory(folder);
    ...
    {
        string folder = Path.Combine(Path.GetTempPath(), $"stockifhsgui-opening-split-{Guid.NewGuid():N}");
        Directory.CreateDirectory(folder);
    ...
    {
        string folder = Path.Combine(Path.GetTempPath(), $"stockifhsgui-opening-log-{Guid.NewGuid():N}");
        Directory.CreateDirectory(folder);
    ...
    {
        string folder = Path.Combine(Path.GetTempPath(), $"stockifhsgui-opening-plusmate-{Guid.NewGuid():N}");
        Directory.CreateDirectory(folder);
    ...
    {
        string folder = Path.Combine(Path.GetTempPath(), $"stockifhsgui-opening-ke7-{Guid.NewGuid():N}");
        Directory.CreateDirectory(folder);
